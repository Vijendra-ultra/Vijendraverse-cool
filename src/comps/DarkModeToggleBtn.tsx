import { DarkModeSwitcher } from "@/utils/functions";

const DarkModeToggleBtn = () => {
  return (
    <div
      className="      rounded-md   transition-all ease-linear duration-100  bg-gray-100 dark:bg-darkModeBlack hover:bg-gray-200 dark:hover:bg-gray-700
  md:bg-transparent md:dark:bg-darkModeBlack md:hover:bg-white   "
    >
      <button
